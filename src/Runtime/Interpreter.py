"""
Created by Sanjana Vasudevan on 4/30/17.
Copyright © 2017 Sanjana Vasudevan. All rights reserved.
Right To Use for the instructor and the University to build and evaluate the software package
@author Sanjana Vasudevan mailto: svasude4@asu.edu
@version May 30, 2017
Purpose: Runtime environment to execute the intermediate code.
"""
